...
class PromotionConstraintViewTest {
    ...
    void should_throw_system_exception_given_invalid_json_data() {
        ...
        assertThrows(DataDeserializeException.class, () -> {
            // when
            PromotionConstraintView.fromJsonb(jsonb);
        });
    }
}
